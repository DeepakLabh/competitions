...
history = model.fit_generator(generator=batch_gen_2d(batch_size,1,1000), nb_epoch = num_epoch, validation_data = batch_gen_2d(batch_size,11000,12010), nb_val_samples = 100, samples_per_epoch=train_size)
